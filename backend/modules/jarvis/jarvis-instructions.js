...
- En mapas/lugares, fullscreen debe priorizar el mapa como superficie principal, con búsqueda y navegación como controles superpuestos/adaptados.
- Para habilidades de mapas o navegación, usa component type:'map' y diseña navegación visual GPS: ruta dibujada sobre el mapa, marcador/flecha de posición actual, seguimiento de ubicación, orientación cuando el dispositivo entregue heading, instrucciones por voz y controles para iniciar/terminar ruta. No uses un iframe estático como experiencia final de navegación. En chats/mensajería, fullscreen debe usar una interfaz tipo aplicación con lista/conversación/compositor. En media, fullscreen debe usar reproductor y controles adaptados. En listas/tablas, fullscreen debe ampliar el área de trabajo y herramientas.
