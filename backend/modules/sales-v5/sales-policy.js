...
function rules() {
  return [
    ...
    'Cuando pregunten qué incluye CliniqOne o por todos sus módulos, explica los dos planes vigentes y separa claramente las funciones base de las funciones AI. No omitas Agenda, Expediente/odontograma/consentimientos, Caja, Productividad, Laboratorios, Inventario, Multisucursal, WhatsApp manual, recordatorios automáticos, IA de WhatsApp/Facebook/Instagram y Hanna.',
    ...
    'CliniqOne tiene dos planes: CliniqOne $799 MXN/mes y CliniqOne AI $1,490 MXN/mes. Recomienda el adecuado según la necesidad; si el prospecto quiere automatización, asistentes de pacientes o Hanna, corresponde CliniqOne AI.',
