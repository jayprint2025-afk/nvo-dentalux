...
const app = express(); // 👈 SI NO LO TIENES AQUÍ, créalo aquí

// ✅ CORS (AQUÍ EXACTAMENTE)
app.use(cors({
  origin: [
    'http://localhost:5173',
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'x-sucursal', 'x-db', 'x-app']
}));

app.options('*', cors());

// ✅ luego tus middlewares normales
