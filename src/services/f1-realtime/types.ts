import type { F1VoiceEngineStatus } from "../f1-voice";

export type F1AudioState =
  | "DISABLED" | "WAKE_STARTING" | "WAKE_LISTENING" | "WAKE_DETECTED"
  | "REALTIME_CONNECTING" | "REALTIME_GREETING" | "REALTIME_LISTENING"
  | "REALTIME_PROCESSING" | "REALTIME_SPEAKING" | "REALTIME_FOLLOWUP"
  | "REALTIME_DISCONNECTING" | "BRIEFING_PLAYING" | "ERROR";

export type MicrophoneOwner = "none" | "wake" | "realtime";
export type DisconnectReason = "manual" | "followup-timeout" | "idle-timeout" | "max-session" | "briefing" | "disabled" | "error";
...
export interface RealtimeToolCall { name: string; callId: string; argumentsJson: string; }
